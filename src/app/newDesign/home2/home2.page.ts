...
import { AlertController, IonRouterOutlet, IonSearchbar, LoadingController, Platform, ToastController } from '@ionic/angular';
    ...
    if (this.token !== null) {
      ...
      this.auth.getShopuser().subscribe({
        next: (data) => {
          ...
          this.imageData = data.getUser.imagePath;
          this.customerData = data.getUser;
          // this.filterShopList = data.getUser.shop
        ...
        this.auth.getshop(id, this.latlng[0], this.latlng[1]).subscribe({
          ...
          //  this.shopsData = data
            for(let i=0;i<data.length;i++){
              // console.log()
              this.shopsData =data[i]
              console.log(this.shopsData);
              // console.log(this.shopsData[i].location[i].coordinates)
              
            }
            console.log(this.shopsData);
            console.log(this.shopsData._id)
            ...
            const params: NavigationExtras = {
              ...
              //   lng: this.latlng[1],
              // },
              queryParams: { shopUser_id:this.shopsData._id,shop_id:id,latlng: this.latlng,shopLocation:this.latlng,category_name: this.categoryName}
            };
