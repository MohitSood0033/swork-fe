...
import { AuthGuard } from './newDesign/guards/auth.guard';
import { LoginGuard } from './newDesign/guards/login.guard';
...
const routes: Routes = [
  ...
  {
    path: 'register1',
    loadChildren: () => import('./newDesign/register1/register1.module').then( m => m.Register1PageModule),
    canActivate:[LoginGuard]
  },
  {
    path: 'register2',
    loadChildren: () => import('./newDesign/register2/register2.module').then( m => m.Register2PageModule),
    
  },
  {
    path: 'login1',
    loadChildren: () => import('./newDesign/login1/login1.module').then( m => m.Login1PageModule),
    canActivate:[LoginGuard]
  },
  {
    path: 'home1',
    loadChildren: () => import('./newDesign/home1/home1.module').then( m => m.Home1PageModule)
  },
  {
    path: 'home2',
    loadChildren: () => import('./newDesign/home2/home2.module').then( m => m.Home2PageModule)
  },
  {
    path: 'customer-profile',
    loadChildren: () => import('./newDesign/customer-profile/customer-profile.module').then( m => m.CustomerProfilePageModule),
    canActivate: [AuthGuard] 
  },
  {
    path: 'onbord',
    loadChildren: () => import('./newDesign/on-bord/on-bord.module').then( m => m.OnBordPageModule),
    canActivate:[LoginGuard]
  },
  {
    path: 'add-cart',
    loadChildren: () => import('./newDesign/add-cart/add-cart.module').then( m => m.AddCartPageModule)
  },  {
    path: 'order-details',
    loadChildren: () => import('./newDesign/order-details/order-details.module').then( m => m.OrderDetailsPageModule)
  }
