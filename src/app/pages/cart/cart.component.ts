...
import { ShopProductDetailsPageRoutingModule } from '../shop-product-details/shop-product-details-routing.module';
...
export class CartComponent implements OnInit {
  component= ShopProductDetailsPageRoutingModule
  orderData: any;
  errorMessage: any;
  message: any;
  su_id: any;
...
console.log('itemmdata',this.itemData,this.su_id)
    ...
    this.customerData.itemCountvalue = this.itemCount._value
